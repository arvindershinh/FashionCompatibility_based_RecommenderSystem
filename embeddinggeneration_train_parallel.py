...
path = "Data/"
json_file = os.path.join(path, 'train_no_dup.json')
...
if __name__ == '__main__':
    ...
    now = datetime.now()
    train_features = imageEmbedding(all_sets)
    a, b, c = train_features[0]

    print("train features : ", len(a), type(a), b.shape, c.shape)

    train_features_path = 'train_features.p'

    pickle.dump(train_features[0], open(train_features_path, "wb"))
    print("train_features.p is ready!")
